...
// Los valores reales ahora se leen del archivo .env (que NO se sube a GitHub)
...
const API = {
    ...
    login: async (email, password) => {
        if (!API.isConfigured() || email === 'empresa@demo.cl') {
            ...
            <div className="hero-bg" style={{ padding: '80px 32px 60px', alignItems: 'center', justifyContent: 'center', textAlign: 'center' }}>
                <div style={{ maxWidth: 720 }}>
                    ...
                    <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
                        ...
                        <a href="#como-funciona" className="btn" style={{ background: 'rgba(255,255,255,.15)', color: '#fff', fontSize: 16, padding: '14px 28px', textDecoration: 'none' }}>
                            Ver demo
                        </a>
                    </div>
...
export default function FirmaRapida() {
    ...
    const handleLogin = async (email, pass) => {
        if (email && typeof email === 'object') email = null; // Ignorar el evento DOM nativo de React
        try {
